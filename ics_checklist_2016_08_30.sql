...
--
-- Host: localhost
-- Generation Time: Aug 30, 2016 at 12:26 PM
...
(6, 'test recommendation', 'test 123 test');
...
(5, 'test recommendation', 'test 123 test');
...
--
ALTER TABLE `devices`
ADD CONSTRAINT `fk_series_devices` FOREIGN KEY (`series`) REFERENCES `series` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fk_vendor_devices` FOREIGN KEY (`vendor`) REFERENCES `vendors` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `device_services`
--
ALTER TABLE `device_services`
ADD CONSTRAINT `fk_service_deviceservices` FOREIGN KEY (`service`) REFERENCES `services` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fk_device_deviceservices` FOREIGN KEY (`device`) REFERENCES `devices` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `device_types`
--
ALTER TABLE `device_types`
ADD CONSTRAINT `fk_type_devicetypes` FOREIGN KEY (`type`) REFERENCES `types` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fk_device_devicetypes` FOREIGN KEY (`device`) REFERENCES `devices` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `protocol_warnings`
--
ALTER TABLE `protocol_warnings`
ADD CONSTRAINT `fk_warning_protocolwarnings` FOREIGN KEY (`warning`) REFERENCES `warnings` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fk_protocol_protocolwarnings` FOREIGN KEY (`protocol`) REFERENCES `protocols` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `series`
--
ALTER TABLE `series`
ADD CONSTRAINT `fk_vendor_series` FOREIGN KEY (`vendor`) REFERENCES `vendors` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `service_protocols`
--
ALTER TABLE `service_protocols`
ADD CONSTRAINT `fk_protocol_serviceprotocols` FOREIGN KEY (`protocol`) REFERENCES `protocols` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fk_service_serviceprotocols` FOREIGN KEY (`service`) REFERENCES `services` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `warning_recommendations`
ADD CONSTRAINT `fk_recommendation_warningrecommendations` FOREIGN KEY (`recommendation`) REFERENCES `recommendations` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fk_warning_warningrecommendations` FOREIGN KEY (`warning`) REFERENCES `warnings` (`id`) ON DELETE CASCADE;
